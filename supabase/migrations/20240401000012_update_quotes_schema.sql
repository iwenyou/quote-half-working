...
-- Add comments
COMMENT ON TABLE quotes IS 'Stores cabinet project quotes';
COMMENT ON TABLE spaces IS 'Stores spaces/rooms within a quote';
COMMENT ON TABLE items IS 'Stores individual cabinet items within a space';